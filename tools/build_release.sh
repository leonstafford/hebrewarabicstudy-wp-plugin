...
rm -Rf "$TMP_DIR/hebrewarabicstudy-wp-plugin"
mkdir "$TMP_DIR/hebrewarabicstudy-wp-plugin"
...
cp -r "$EXEC_DIR"/*.php "$TMP_DIR"/hebrewarabicstudy-wp-plugin/
...
zip --quiet -r -9 "./$1.zip" ./hebrewarabicstudy-wp-plugin
